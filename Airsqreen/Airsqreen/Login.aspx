<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Airsqreen.Login" %>
...
<div class="loginWrapper">
    ...
    <div class="widget">
        <div class="title"><img src="/assets/images/icons/dark/files.png" alt="" class="titleIcon" /><h6>Login panel</h6></div>
        <form action="#" id="validate" class="form" runat="server">
            <fieldset>
                ...
                <div class="loginControl">
                    ...
                    <asp:Button ID="Button_login" runat="server" Text="Login" class="dredB logMeIn" OnClick="Button_login_Click"   />
                    <div class="clear"></div>
                </div>
            </fieldset>
        </form>
